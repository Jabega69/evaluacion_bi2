            ...
            <div className="no-print flex flex-col md_flex-row" style={{
                ...
                <div style={{ flex: '0 1 auto' }}>
                    <h2 style={{ fontSize: '1.1rem', fontWeight: 950, color: '#0F172A', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
                        {viewMode === 'standard' ? 'Acta de resultados' : 'Detalles de evaluación'} 📑 <span style={{ fontSize: '0.45rem', verticalAlign: 'middle', opacity: 0.3 }}>v5.0 - Project Distribution</span>
                    </h2>
                ...
                <div style={{
                    ...
                    >
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M21 15v5.0 - Project Distribution 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
